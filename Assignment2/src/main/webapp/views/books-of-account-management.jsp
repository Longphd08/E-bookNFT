                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Xin chào Admin, <span>chúc bạn một ngày tốt lành!</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                                    ...
                                    <div class="basic-form">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="accountID" class="form-control input-default" placeholder="Tên tài khoản">
                                            </div>
                                            <div class="form-group">
                                                <label>Tên sách</label>
                                                <input type="text" name="bookID" class="form-control input-default" placeholder="Tên sách">
                                            </div>
                                            <div class="form-group">
                                                <label>Tiến trình đọc</label>
                                                <input type="text" name="progress" class="form-control input-default" placeholder="Tiến trình đọc">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Người ru ngủ</td>
                                                    <td>100</td>
                                                    <td><span class="badge badge-secondary">Đang hiệu lực</span></td>
